                                ...
                                sessions.map((session) => (
                                    ...
                                    >
                                        ...
                                        {deletingId === session.id ? (
                                            // Confirmation state - absolute positioned
                                            <div className="absolute right-1 top-1/2 -translate-y-1/2 flex items-center gap-0.5 bg-card/95 backdrop-blur-sm rounded-md" onClick={(e) => e.stopPropagation()}>
                                                <Button
                                                    variant="ghost"
                                                    size="icon"
                                            ...
                                            // Normal state - absolute positioned, show on hover
                                            <Button
                                                variant="ghost"
                                                size="icon"
