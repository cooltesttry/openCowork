...
export function ImageEditor({ initialImage, addImagePath, openInAITool, onSave, onHasContentChange, onExportRequest, autoFitToken, modeToggle, workspacePath, onReferenceBarToggle }: ImageEditorProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-zinc-50 dark:bg-zinc-800">
      {/* Toolbar */}
      <Toolbar
        state={state}
        actions={actions}
      ...
      {/* Status bar */}
      <div className="flex items-center justify-between px-3 py-1.5 bg-zinc-50 dark:bg-zinc-800 border-t border-zinc-200 dark:border-zinc-700 text-xs text-zinc-500">
