        ...
        return (
            ...
            <div className="p-4 border-t bg-background relative">
                <div className="max-w-4xl mx-auto relative">
                    ...
                    <div className="flex flex-col border rounded-xl bg-background shadow-sm focus-within:border-blue-400 focus-within:ring-1 focus-within:ring-blue-400 transition-all">
                                            ...
                                            <TooltipTrigger asChild>
                                                <DropdownMenuTrigger asChild>
                                                    <Button
                                                        variant="ghost"
                                                        size="sm"
                                                        className={`h-8 px-2 gap-1.5 font-normal ${currentMode.color}`}
                                                    >
                                                        {currentMode.icon}
